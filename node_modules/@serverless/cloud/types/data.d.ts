...
interface iAdd {
  <T>(key: string, value: number, opts?: addOptions | boolean): Promise<AddResponse<T>>
  <T>(key: string, attribute: string, value: number, opts?: addOptions | boolean): Promise<AddResponse<T>>
}
